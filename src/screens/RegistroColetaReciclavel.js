...
const RegistroColetaReciclavel = () => {
  ...
  const handleRegister = async () => {
    ...
    const coletaData = {
      TipoResiduo: "Material Reciclável",
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Material Reciclável</Text>
...
export default RegistroColetaReciclavel;
